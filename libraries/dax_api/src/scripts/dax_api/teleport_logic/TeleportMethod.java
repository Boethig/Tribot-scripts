...
public enum TeleportMethod implements Validatable {
    ...
    SALVE_GRAVEYARD_TELEPORT(TeleportConstants.LEVEL_20_WILDERNESS_LIMIT, SALVE_GRAVEYARD),
    ...
    public boolean canUse() {
        ...
        switch (this) {
            ...
            case MORTTON_TELEPORT_SCROLL:
                System.out.println("MORTON TELEPORT: " + TeleportScrolls.MORTTON.hasScroll() + (TeleportScrolls.MORTTON.canUse() && inMembersWorld()));
            ...
            case SALVE_GRAVEYARD_TELEPORT:
                return inMembersWorld() && Inventory.getCount("Salve graveyard teleport") > 0;
        }
        return false;
    }
    ...
    public boolean use(TeleportLocation teleportLocation) {
        ...
        switch (teleportLocation) {
            ...
            case SALVE_GRAVEYARD:
                return RSItemHelper.click("Salve graveyard teleport", "Break");
        }
        return false;
    }
