...
import scripts.rsitem_services.grand_exchange_api.GrandExchangePriceService;
 ...
 *
 * By default, uses the RSBuddy scripts.boe_api service primarily, and the GE scripts.boe_api as a backup
 */
public class GrandExchange extends org.tribot.api2007.GrandExchange
{
    ...
    /**
     * Attempts to get the price of the item via the RSBuddy scripts.boe_api or GE scripts.boe_api (whichever is accessible)
    ...
    /**
     * Attempts to get the name of the item via the RSBuddy scripts.boe_api or GE scripts.boe_api (whichever is accessible)
     * @param itemId The item to lookup
    ...
    /**
     * Attempts to get the members status of the item via the RSBuddy scripts.boe_api or GE scripts.boe_api (whichever is accessible)
     * @param itemId The item to lookup
